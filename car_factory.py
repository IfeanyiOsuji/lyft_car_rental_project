...
class CarFactory:
    @staticmethod
    def create_calliope(last_service_date, current_date, current_mileage, last_service_mileage)->Car:
    ...
    @staticmethod
    def create_glissade(last_service_date, current_date,current_mileage, last_service_mileage)->Car:
        ...
        return glissade
    @staticmethod
    def create_palindrome(last_service_date, current_date,warning_light_is_on)->Car:
    ...
    @staticmethod
    def create_rorscharch(last_service_date,current_date, current_mileage, last_service_mileage)->Car:
        ...
        return rorscharch
    @staticmethod
    def create_thovax(last_service_date,current_date, current_mileage, last_service_mileage)->Car:
